...
let expName = 'nBackBeta2';  // from the Builder filename that created this script
...
function experimentInit() {
  ...
  instr1Img = new visual.ImageStim({
    win : psychoJS.window,
    name : 'instr1Img', units : undefined, 
    image : '1back.png', mask : undefined,
  ...
  instr2Image = new visual.ImageStim({
    win : psychoJS.window,
    name : 'instr2Image', units : undefined, 
    image : '2back.png', mask : undefined,
  ...
  instr3Image = new visual.ImageStim({
    win : psychoJS.window,
    name : 'instr3Image', units : undefined, 
    image : '3back.png', mask : undefined,
...
function instructions1RoutineBegin(trials) {
  return function () {
    ...
    instructions1Components.push(instr1Img);
...
function instructions1RoutineEachFrame(trials) {
  return function () {
    ...
    // *instr1Img* updates
    if (t >= 0.0 && instr1Img.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      instr1Img.tStart = t;  // (not accounting for frame time here)
...
function instructions2RoutineBegin(trials) {
  return function () {
    ...
    instructions2Components.push(instr2Image);
...
function instructions2RoutineEachFrame(trials) {
  return function () {
    ...
    // *instr2Image* updates
    if (t >= 0.0 && instr2Image.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      instr2Image.tStart = t;  // (not accounting for frame time here)
...
function instructions3RoutineBegin(trials) {
  return function () {
    ...
    instructions3Components.push(instr3Image);
...
function instructions3RoutineEachFrame(trials) {
  return function () {
    ...
    // *instr3Image* updates
    if (t >= 0.0 && instr3Image.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      instr3Image.tStart = t;  // (not accounting for frame time here)
